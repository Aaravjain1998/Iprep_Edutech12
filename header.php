...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>IPREP EDUTECH</em></strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reservation.php" >New Registration</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_reservations.php" >View Details</a>
                    </li>';
	            ...
	            <li class="nav-item">
	                <a class="nav-link" href="#gallery">Courses</a>
	            </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#reservation">Subscription</a>
                    </li>
                    <li class="nav-item">
