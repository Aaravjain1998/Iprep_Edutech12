...
<br><br>
<div class="container">
    <h3 class="text-center"><br>New Subscription<br></h3>   
    <div class="row">
  ...
  //error handling:
    ...
    if(isset($_GET['error3'])){
        ...
        if(isset($_GET['reservation'])) {   
           if($_GET['reservation'] == "success"){ 
            echo '<h5 class="bg-success text-center">Your registration was successfull!</h5>';
        }
        }
        echo'<br>';
    ...
    <div class="signup-form">
        <form action="includes/reservation.inc.php" method="post">
            ...
            <div class="form-group">
            <label>Enter number of Course</label>
        	<input type="number" class="form-control" min="1" name="num_guests" placeholder="Course" required="required">
                <small class="form-text text-muted">Minimum value is 1</small>
            </div>
            <div class="form-group">
            <label for="guests">Enter your Mobile Number</label>
                <input type="telephone" class="form-control" name="tele" placeholder="Mobile" required="required">
		...
		<label class="checkbox-inline"><input type="checkbox" required="required"> I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
            ...
            <div class="form-group">
            <button type="submit" name="reserv-submit" class="btn btn-dark btn-lg btn-block">Submit Application</button>
            </div>
        </form>
        <br><br>
    </div>
